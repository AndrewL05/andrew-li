...
const Browser = ({
  ...
  const c = light
    ? {
      ...
      tabInactive: "text-[#a89e8e] hover:text-[#3c3226] hover:bg-[#e8e2d8] border border-transparent",
    ...
    : {
      ...
      tabInactive: "text-white/30 hover:text-white/70 hover:bg-white/[0.05] border border-transparent",
